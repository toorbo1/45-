...
// Зеленая капля - центрирована по вертикали
...
(function() {
    ...
    function animateToTab(newTabId) {
        ...
        animTimer = setTimeout(() => {
            ...
            mainBlob.style.transform = 'translateY(-50%) scale(1.05)';
            
            setTimeout(() => {
                mainBlob.style.transform = 'translateY(-50%) scale(1)';
            }, 200);
    ...
    function initBlobNavigation() {
        ...
        setTimeout(() => {
            if (mainBlob) {
                ...
                mainBlob.style.transform = 'translateY(-50%) scale(1.02)';
                setTimeout(() => {
                    if (mainBlob) mainBlob.style.transform = 'translateY(-50%) scale(1)';
                }, 200);
                setTimeout(() => {
                    if (mainBlob) mainBlob.style.transition = '';
                }, 250);
            }
        }, 300);
